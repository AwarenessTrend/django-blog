...
class CommentDetailsForm(CommentSecurityForm):
    ...
    #以下字段为个人改动
    comment_title = forms.CharField(label=_('评论标题'),max_length=256)
    # 值为-1表示没有父评论
    parent_id = forms.IntegerField(min_value=-1,label='父评论的ID')
    level = forms.IntegerField(min_value=0,label='层级')
    ...
    def get_comment_create_data(self, site_id=None):
        ...
        if parent_id <= 0:
            ...
            _level = self.cleaned_data['level'] + settings.MULTILEVEL_COMMENT_INDENTATION
